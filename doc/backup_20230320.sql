...
INSERT INTO `category` (`id`, `id_media`, `name`, `content`) VALUES
	(1, 38, 'Xe cộ', 'Các loại xe'),
	(2, 40, 'Đồ dùng gia đình', 'Các đồ dùng trong gia đình'),
	(3, 39, 'Đồ điện tử', 'Các loại đồ điện tử');
...
INSERT INTO `post` (`id`, `id_product`, `id_user`, `title`, `content`, `total_view`, `total_like`, `total_follow`, `total_comment`, `created_date`, `updated_date`) VALUES
	...
	(18, 27, 2, 'Điện thoại iPhone 12 Pro Max 256GB – Like New 99%', 'Chức năng hoạt động tốt', 0, 0, 0, 0, '2023-02-27 08:59:54', '2023-02-27 08:59:54'),
...
-- Dumping data for table webtraodoisp.post_user: ~16 rows (approximately)
...
INSERT INTO `product` (`id`, `id_category`, `id_user`, `id_confirmer`, `name`, `price`, `price_verify`, `id_status`, `created_date`) VALUES
	(1, 1, 2, 1, 'Test', 1000, 1100, 6, '2022-12-11 20:41:39'),
	(2, NULL, 1, NULL, 'Sp 1', 20000, NULL, 5, '2022-12-13 09:47:43'),
	(3, 2, 1, 1, 'Sp 1', 20000, 20000, 9, '2022-12-13 09:53:05'),
	(4, 1, 1, 1, 'Sp2', 3000, 3000, 8, '2022-12-13 09:58:20'),
	(5, 1, 1, 1, 'Sp 3', 30000, 30000, 9, '2022-12-13 15:11:42'),
	(6, 1, 1, 1, 'test 1', 12312312, 12312312, 6, '2022-12-13 15:16:14'),
	(7, 1, 1, 1, 'Test 1', 1000, 10000, 6, '2023-02-06 13:45:31'),
	(8, 2, 2, 1, 'Test 2', 5000, NULL, 7, '2022-12-14 16:37:14'),
	(9, 1, 3, 1, 'User1 Product 1', 3000, 3000, 8, '2022-12-16 16:49:16'),
	(10, 1, 3, 1, 'User1 Product 2', 2000, 2000, 9, '2022-12-17 11:03:54'),
	(11, 2, 2, NULL, 'User Product 3', 30000, NULL, 5, '2022-12-23 09:50:41'),
	(12, 1, 2, 1, 'Hyundai Elantra 2022', 300000000, 300000000, 5, '2022-12-23 09:59:12'),
	(13, 1, 4, NULL, 'Xe máy', 10, NULL, 5, '2023-02-02 11:16:12'),
	(14, 1, 4, NULL, 'Xe máy', 10, NULL, 5, '2023-02-02 11:16:49'),
	(15, 1, 4, NULL, 'Xe máy', 10, NULL, 5, '2023-02-02 11:16:53'),
	(16, 1, 4, NULL, 'Xe máy', 10, NULL, 5, '2023-02-02 11:17:30'),
	(17, 1, 1, NULL, 'Xe máy', 10000, NULL, 5, '2023-02-04 20:10:33'),
	(18, 1, 1, NULL, 'Xe máy', 10000, NULL, 5, '2023-02-04 20:12:57'),
	(19, 1, 3, NULL, 'Test product 1', 100000, NULL, 5, '2023-02-05 19:30:39'),
	(20, 1, 3, NULL, 'Sp Test 1', 1000000, NULL, 5, '2023-02-05 19:32:59'),
	(21, 1, 3, NULL, 'test 1', 100000, NULL, 5, '2023-02-05 19:42:03'),
	(22, 1, 2, 1, 'Xe ô tô', 10000, NULL, 8, '2023-02-06 13:42:49'),
	(23, 2, 3, 1, 'Sp Test 1', 1000, NULL, 5, '2023-02-06 13:47:29'),
	(24, 1, 3, 1, 'Sp Test 12', 1000, 1000, 9, '2023-02-06 13:49:20'),
	(25, 1, 2, 1, 'Áo', 30000, NULL, 6, '2023-02-15 12:57:06'),
	(26, 1, 2, 1, 'Xe máy Wave alpha 2022', 18190000, 18190000, 8, '2023-02-27 08:56:11'),
	(27, 3, 2, 1, 'Điện thoại iPhone 12 Pro Max 256GB – Like New 99%', 16190000, 16190000, 6, '2023-02-27 08:59:54'),
	(28, 2, 2, 1, 'Nồi nhôm chống dính Suit Lock&Lock', 556000, 556000, 6, '2023-02-27 09:06:09'),
	(29, 1, 3, 1, 'Ô tô', 100000, 100000, 8, '2023-02-27 09:18:05');
...
INSERT INTO `user` (`id`, `username`, `password`, `full_name`, `address`, `email`, `phone`, `gender`, `id_role`, `created_date`) VALUES
	...
	(4, 'manhnv', 'manhnv', 'Nguyễn Văn Mạnh', 'Ha Noi', 'manhnguyen1422000@gmail.com', '0895452', 0, NULL, '2023-02-02 11:12:55');
